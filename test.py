...
converter_input = open("aa_test.txt","r")
...
if results[0] == "a": # write processing paramaters 1 and 2: radius, line or shape or form
...
if results[3] == "a": # write processing paramater 4: texture
...
if results[4] == "a": # write processing paramater 5: color
...
if results[7] == "a":
    processing_input.write("255,165,0\n") # orange
elif results[7] == "b":
